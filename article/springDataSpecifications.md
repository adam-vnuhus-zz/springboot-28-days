...
## Tại sao chúng ta cần Specifications???
...
## Viết các truy vấn với Specifications
...
## Truy vấn động với Specifications
...
Chúng ta sẽ hiển thị đối tượng này cho _clients_ của chúng ta thông qua REST API.
...
Bây giờ, hãy thử tìm nạp tất cả các sản phẩm thuộc danh mục `MOBILE` hoặc `TV APPLIANCE` và có giá dưới _1000_ bằng cách sử dụng trình tạo truy vấn `specifications` động mới của chúng ta.
...
## Khi nào ta nên sử dụng Specifications qua Query Methods?
